...
if(isset($_POST['login'])){
    ...
    if(!isset($_POST['username']) || $_POST['username'] == ''){
        ...
        $errors[] = urlencode('Lietotājvārds nav ievadīts');
    ...
    if(!isset($_POST['password']) || $_POST['password'] == ''){
        ...
        $errors[] = urlencode('Parole nav ievadīta');
        ...
        if($row == 1){
            ...
            if(password_verify($password, $rows->password)){
               ...
               session_start();
                ...
                $error = urlencode("Nepareiza parole");
            ...
            $error = urlencode("Lietotājvārds vārds nav reģistrēts");
