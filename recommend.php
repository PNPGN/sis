    ...
    if(!$error){
        ...
        if($db_con->affected_rows == 1){
           ...
           if($db_con->affected_rows == 1){
               ...
               $subject = "Darbinieka atvaļinājums";
               
               $message = "Sveiks $firstname!\r\n\tAtvaļinājums ID 
                      $leave_id ir nosūtīts direktoram."
                       . "\r\n\r\n\t\t\tVēlu veiksmi!";
    ...
    if(!$error){
        ...
        if($db_con->affected_rows == 1){
            ...
            if($db_con->affected_rows == 1){
               ...
               $subject = "Noraidīts atvaļinājums";
               
               $reason = wordwrap($reason,70,'\r\n');
               
               $message = "Sveiks $firstname!\r\n\tTavs atvaļinājums ar ID $leave_id ir ticis noraidīts:\r\n\"$reason\"\r\nSazinies ar savu Vadītāju.\r\n\r\n\t\t\t
                      Vēlu veiksmi!";
               ...
               if(mail($to, $subject, $msg, $from)){
                    ...
                    $msg = urlencode("Atvaļinājums noraidīts");
