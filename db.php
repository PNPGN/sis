...
$query = "CREATE TABLE IF NOT EXISTS leaves(id INT NOT NULL AUTO_INCREMENT
    PRIMARY KEY, leave_id BIGINT NOT NULL UNIQUE, leave_type ENUM('ikgadējais',
    'bērnu kopšanas','studiju','bezalgas','papilddienu','īslaicīga prombūtne','ilgstoša prombūtne') NOT NULL, allowed_days BIGINT NOT NULL,
