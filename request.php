...
if(isset($_POST['request'])){
    ...
    if(var_set($_POST['leave_start_date'])){
        ...
        $errors[] = urlencode("Ievadiet sākuma atvaļinājuma datumu");
    }
    ...
    if(var_set($_POST['leave_end_date'])){
        ...
        $errors[] = urlencode("Ievadiet beigu atvaļinājuma datumu");
    }
    ...
    if($range <= 0){
        $errors[] = urlencode("Sākuma datums ir mazāks par beigu datumu");
    }
    ...
    if(var_set($_POST['leave_id'])){
        ...
        $errors[] = urlencode("Ievadiet atvaļinājuma veidu");
    }
    ...
    if($r->num_rows == 1){
        ...
        $errors[] = urlencode("Šāds atvaļinājuma veids jau ir bijis pieprasīts");
    }
    ...
    if(!$errors){
        ...
        if($db_con->affected_rows == 1){
            ...
            $msg = urlencode("Veksmīgi pieprasīts");
