        ...
        if($rows == 1){
            ...
            $len = <<<_
                <div class="container my-5">
                    <div class="card">
                    <h1 class="text-lg-2">Paroles maiņa</h1>
                    <form action="update.php" method="post">
                        ...
                        <label for="conf-pass">Jaunā parole vēlreiz</label>
                        <input type="password" name="confpassword" id="conf-pass" required>
                         <div class="error-line2 text-sm text-red"></div>
                        <button class="btn btn-success" name="update-pass">Mainīt</button>
                   </form>
                </div>
_;
        echo $len;
    ...
    $len = <<<_Pad
        <div class="container my-5">
            <div class="card">
            <h1 class="text-lg">Ievadi savu e-pastu</h1>
            <p>Ievadi savu e-pastu, lai varētu nosūtīt uz Jūsu epastu jauno paroli.
            </p>
            <form action="mail.php" method="post">
                ...
                <button class="btn btn-success" name="recover_password">Nosūtīt paroli</button>
           </form>
        </div>
_Pad;
    echo $len;
