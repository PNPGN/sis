...
if($result->num_rows > 0){
    echo "<h1 class='text-center hide'>Vadītāja loma</h1>

            <form action='process.php' method='post'>

            
            <label for='select'>Jauna Vadītāja loma</label>
...
if($res->num_rows > 0){
    ...
    <h1 class="text-md text-center">Jauna Vadītāja Loma</h1>
        ...
        $student = <<<STAFF
                <tr>
                    ...
                    <td><form action="$here?tab=7" method="post">
                        ...
                        <button class="btn success-btn" name='make_super'>Izveidot Vadītāju</button>
                        </form>
                    </td>
...
if(isset($_POST['make_super'])){
    ...
    if(var_set($_POST['staff_id'])){
        ...
        $errors[] = urlencode("ERROR: Mēģiniet vēlreiz");
    }
