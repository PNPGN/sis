...
echo '<div class="card mb-md-5">
        <h1 class="text-center mb-4 text-md">Pieprasītie atvaļinājumi</h1>
...
if($rows > 0){
    ...
    echo '<div class="card mb-md-5 mt-5">
        <h1 class="text-center text-md">Statistika</h1>
        <table class="table table-bordered table-responsive-sm w-100">
        <thead class="thead-dark">
            <th>ID</th>
            <th>Atvaļinājuma veids - '.$staff_id.'</th>
            <th>Atļauto dienu skaits</th>
            <th>Atļautās mēneša dienu skaits</th>
