...
<div class="container">
<h1 class="text-hide">Reģistrēties</h1>

<h4 class="text-center">Konta reģistrācija</h4>
...
?>
    ...
    <form action="process.php" method="post" id="signup">
        ...
        <div class="container el">
            <label class="padding-none">Tel. nummurs</label>
            <hr class="divider">

            <div class="row">
                <div class="col-4 stacked-el">
                    <label for="code" class="text-sm padding-none"></label><br>
                ...
                <div class="col-8 stacked-el">
                    <label for="phone" class="text-sm padding-none"></label><br>
        ...
        <p class="text-sm">
           Esi reģistrējies?
            <a href="index.php" class="text-sm">Ielogoties</a>
        </p>
    </form>
    </div>
   </div>
